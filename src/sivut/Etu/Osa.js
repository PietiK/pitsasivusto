...
export const OsaKuva = (kuva) => {
  return (
    <div className='osalaatikko'>
      <h3 className='osaotsikko'>Pitsako vittu</h3>
      ...
      usein edamjuustoa tai sinihomejuustoa, mutta käytetään myös mozzarellaa. (lähde: Wikipedia) </p>
      <img src={Pepe} className='osapepe'/>
      <h3 className='osaotsikko2'>Pitsako vittu</h3>
